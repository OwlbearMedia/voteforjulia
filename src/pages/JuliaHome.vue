...
useHead(
  buildPageHead({
    ...
    // Social cards use the bare candidate name rather than the "Home | …" title.
...
<template>
  ...
  <section id="meet-julia">
    ...
    <p>
      Her guiding values include equity, accountability, transparency, dignity, justice, freedom,
      growth, and community.
    </p>
    <div>
      <JuliaButton to="/meet-julia"> Learn more about Julia </JuliaButton>
    </div>
  </section>
  ...
  <section id="issues">
    <div
      class="grid grid-cols-1 items-center gap-12 max-md:gap-6 md:grid-cols-[minmax(0,1fr)_275px]"
    >
      <div class="md:flex md:flex-col md:justify-between md:self-stretch">
