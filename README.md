...
- **[docs/architecture.md](docs/architecture.md)** — the system map: what runs
  ...
  **[docs/adr/](docs/adr/)** explaining why the site is built this way (shared
  ...
  you're new to the project. It also covers the rules the Google Sheet has to
  obey for appends to land in the right place, which the Apps Script in
  [sheets/](sheets/) enforces from inside the spreadsheet.
