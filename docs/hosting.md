...
| `EDGE_SHARED_TOKEN`                   | _unset_                                     | The secret Cloudflare stamps as `X-Origin-Token`. Alphanumeric only. **Unset ⇒ the check does nothing at all**, whatever `EDGE_TOKEN_ENFORCED` says. Must match the Transform Rule and the GitHub secret. [ADR-0020](adr/0020-authenticate-the-origin-path.md)                                                                                                                                                      |
