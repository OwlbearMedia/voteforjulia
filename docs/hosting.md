...
| `INFLIGHT_TTL_SECONDS`                | `60`                                        | How long a slot survives unreleased, for a worker killed mid-request. **Must exceed the SMTP and Sheets timeouts combined** — a test enforces it.                                  |
