...
still works after an attacker changes IP. A submission that fills it or leaves
it out is refused, because both forms always send it blank
([ADR-0025](adr/0025-require-the-honeypot-field.md)). No CAPTCHA — the forms are low-value
...
| [0025](adr/0025-require-the-honeypot-field.md)                   | Require the honeypot field to be present, and keep the form-encoded path | Accepted                                                                                                                                                                                    |
