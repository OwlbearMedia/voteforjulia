...
class SafeGreetingTests(unittest.TestCase):
    ...
    # Name preservation across scripts and normalisation forms lives in
    # test_text_corpus.py, which runs the shared corpus against every
    # registered text transformer. What stays here is greeting-specific.
